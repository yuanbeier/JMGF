...
function loadData(param, success, error) {
    topevery.ajax({
        type: "POST",
        url: "api/services/app/HouseBanR/GetSecurityHouseBanAndUnitInfosAsync",
        ...
        grid = $('#TenantInformationTable').datagrid({
            ...
            columns: [
                [
                    ...
                    { title: '房屋编号', field: 'houseNo', align: 'center', width: '70' },
                    { title: '现房屋门牌', field: 'houseDoorplate', align: 'center', width: '100' },
                    { title: '单元名称', field: 'unitName', align: 'center', width: '100' },
                    { title: '租用范围', field: 'rentRange', align: 'center', width: '100' },
                    ...
                    { title: '建筑面积', field: 'buildArea', width: '70', align: 'center' },
                    { title: '产权属性Id', field: 'propertyId', width: '80', align: 'center', hidden: true },
                    { title: '产权属性', field: 'propertyName', width: '60', align: 'center' },
                    ...
                    { title: '租户名称', field: 'name', width: '80', align: 'center' },
                    { title: '联系电话号码', field: 'contactNumber', width: '80', align: 'center' }
                ]
            ],
