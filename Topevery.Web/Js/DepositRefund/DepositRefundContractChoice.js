...
var ContractIndex = {
    ...
    Initialize: function () {
        $("#contractDataGrid").datagrid({
            columns: [
                [
                    { field: "contractNo", title: "合同编号", width: 70, align: "center" },
                    { field: "houseDoorplate", title: "现房屋门牌", width: 100, align: "center" },
                    { field: "rentRange", title: "租用范围", width: 70, align: "center" },
                    { field: "name", title: "承租人", width: 60, align: "center" },
                    { field: "rentMargin", title: "保证金金额", width: 60, align: "center" },
            ...
            loader: function(param, success, error) {
                topevery.ajax({
                    type: "POST",
                    url: "api/services/app/ContractR/GetDepositRefundContractChoice",
